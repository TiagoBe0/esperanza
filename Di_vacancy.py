...
from ovito.modifiers import ExpressionSelectionModifier,AffineTransformationModifier, InvertSelectionModifier, DeleteSelectedModifier, ConstructSurfaceModifier
import json
import random
import numpy as np
