...
from ovito.modifiers import ExpressionSelectionModifier,InvertSelectionModifier,DeleteSelectedModifier, ConstructSurfaceModifier, DeleteSelectedModifier
import json
import random
import numpy as np
